...
public class AddressControllerIntegrationTest extends AbstractMvcIntegrationTest {
	...
	public void testList() throws Exception {
		mockMvc.perform(get("/sample/list")).andExpect(status().isOk())
				.andExpect(forwardedUrl("/WEB-INF/views/sample/list.jsp"))
	...
	public void testAdd() throws Exception {
		...
		mockMvc.perform(post("/sample/add").param("name", someName).param("age", someAge)).andExpect(
				redirectedUrl("list"));
	}
